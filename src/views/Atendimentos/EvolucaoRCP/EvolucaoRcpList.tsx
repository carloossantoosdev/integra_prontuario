    ...
    return (
        <Box style={{ padding: '20px' }}>
            ...
            {loading ? (
                ...
                <>
                    {vitalsData.length > 0 ? (
                        <Box style={{ marginTop: '20px', height: '400px', width: '100%', overflowX: 'auto' }}>
                        ...
                        <Typography variant="body1" style={{ display: 'flex', width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: '50px' }}>
