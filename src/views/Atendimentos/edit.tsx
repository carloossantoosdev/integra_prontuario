...
export const AppointmentsEdit = () => {
  const {
    ...
    refineCoreProps: {
      meta: {
        select: "nome, data_nascimento, inicio_atendimento, valor, fisioterapeuta, observacoes, ssvv_inicial, ssvv_final",
      },
    },
  });
  ...
  return (
    <Edit isLoading={formLoading} saveButtonProps={saveButtonProps}>
      ...
      >
        ...
        <Typography variant="h6" marginTop={2} fontWeight="bold">Sinais vitais iniciais</Typography>
        <Controller
        ...
        <Typography variant="h6" marginTop={2} fontWeight="bold">Sinais vitais finais</Typography>
        <Controller
          name="ssvv_final.FC"
          control={control}
